                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                <h4 class="text-3xl font-medium text-muted"> Подтвердите свой номер телефона и смотрите наш каталог </h4>

                                <form action="{{ route("sms_process") }}" class="space-y-5 mt-3" method="POST">

                                    @csrf
                                    <label>Номер телефона: </label>
                                    <input type="text" name="user_number" class="form-control mt-2" id="phone" placeholder="Введите номер телефона">
