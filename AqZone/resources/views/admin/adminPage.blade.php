...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse card">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="nav-item">
                        <a href="#aids" class="nav-link {{ (\Illuminate\Support\Facades\Route::currentRouteName() == 'aids') ? 'active' : '' }}"  data-bs-toggle="tab">
                            Пестициды
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
            ...
            <div class="table-responsive">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show {{ (\Illuminate\Support\Facades\Route::currentRouteName() == 'aids') ? 'active' : '' }}" id="aids">
                        {{-- admin users --}}
                        @include('admin.aidsAdmin')
                        {{-- admin users --}}
                    </div>
